...
namespace Scraps.GUI.Constants
{
    ...
    {
        public static readonly Regex CSRF = new(@"ScrapTF\.User\.Hash = ""([a-f0-9]{64})"";", RegexOptions.Compiled);
        ...
        public static readonly Regex BAN_REASON = new(@"<b>Reason:<\/b> ([\w\s]+)", RegexOptions.Compiled);
